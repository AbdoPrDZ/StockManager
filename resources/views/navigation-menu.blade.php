        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link href="{{ route('brands.create.view') }}" :active="request()->routeIs('brands.create.view')">
                        {{ __('Create Brand') }}
                    </x-nav-link>
                    <x-nav-link href="{{ route('products') }}" :active="request()->routeIs('products')">
                        {{ __('Products') }}
                    </x-nav-link>
                    <x-nav-link href="{{ route('products.create.view') }}" :active="request()->routeIs('products.create.view')">
                        {{ __('Create Product') }}
                    </x-nav-link>
                    <x-nav-link href="{{ route('orders') }}" :active="request()->routeIs('orders')">
                        {{ __('Orders') }}
                    </x-nav-link>
                    <x-nav-link href="{{ route('orders.create.view') }}" :active="request()->routeIs('orders.create.view')">
                        {{ __('Create Order') }}
                    </x-nav-link>
                </div>
            </div>
